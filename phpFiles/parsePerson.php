...
$query = "SELECT CONCAT(poi.poi_fname, ' ', poi.poi_lname) as fullName, IFNULL(poi.poi_age, 'Age Unknown') as age, 
			IFNULL(poi.poi_titles, 'No Titles') as titles, IFNULL(IFNULL(gh.gh_name, lh.lh_name), 'Doesn\'t belong to a house') as house, IFNULL(org.org_name, 'N/A') as organization, r.relig_name as religion
